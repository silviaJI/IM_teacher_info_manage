     ...
     <table style="width: 100%; height: 18px; background-color:#ccccff">
        ...
        <table style="width:157px;float:left; margin:3% 3% 5% 5%;">
            ...
            <tr>
             ...
             <tr>
                ...
                <td class="left_nav_active" ><a href="project.aspx">项目信息</a></td>
            </tr>  
        </table>
        ...
        <div style="float:right; margin-right:22%; margin-top:1%;">
				...
				<asp:Button id="Button_search" runat="server" Width="64px" Height="22px" Text="查询" OnClick="Button_search_Click"></asp:Button>
                  ...
                  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  OnRowDataBound="GridView1_RowDataBound"  OnRowDeleting="GridView1_Del" width="60%" style="float:left; margin-top:3%;" DataKeyNames="ID" >
                        <Columns>
                            <asp:BoundField HeaderText="项目编号"  DataField="ID" Visible="false" />
                            <asp:TemplateField HeaderText="项目名称">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" Target="_blank" runat="server" NavigateUrl='<%# "pj_detail.aspx?id="+DataBinder.Eval(Container.DataItem,"id").ToString()%>'><%# DataBinder.Eval(Container.DataItem,"项目名").ToString()%></asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="立项时间">
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "立项时间").ToString()%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
