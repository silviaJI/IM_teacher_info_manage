<%@ Page Language="C#" AutoEventWireup="true" CodeFile="award_detail.aspx.cs" Inherits="award_detail" %>
                    ...
                    <table width="60%" style=" margin-top:3%; margin-left:20%">
                        ...
                        <tr>
                            ...
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="award_name" type="text" value="" class="inputbox" disabled="disabled" runat="server"  /></td>
                        </tr>
                        <tr>
                            <td style="width: 98px; background-color: #ccccff;">
                                教师姓名：</td>
                        ...
                        <tr>
                            <td style="width: 98px; background-color: #ccccff;">
                                奖励名称：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="award_pname" type="text" value="" class="inputbox" disabled="disabled" runat="server" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                获奖时间：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="award_time" type="text" value="" class="inputbox"  runat="server" disabled="disabled"/></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                奖项等级：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="award_level" type="text" value="" class="inputbox"  runat="server" disabled="disabled"/></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                来源部门：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="award_depart" type="text" value="" class="inputbox" runat="server" disabled="disabled"/></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                相关人员：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="award_relaper" type="text" value="" class="inputbox" runat="server" disabled="disabled"/></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                备注：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="award_remark" type="text" value="" class="inputbox"  runat="server" disabled="disabled"/></td>
                        </tr>
