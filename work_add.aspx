<%@ Page Language="C#" AutoEventWireup="true" CodeFile="work_add.aspx.cs" Inherits="work_add" %>
          ...
          <table width="60%" style=" margin-top:3%; margin-left:20%">
                        ...
                        <tr>
                            ...
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="work_name" type="text" value="" class="inputbox"  runat="server"  /></td>
                        </tr>
                        <tr>
                            <td style="width: 98px; background-color: #ccccff;">
                                发表期刊或出版社：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="work_jour" type="text" value="" class="inputbox"  runat="server" /></td>
                        </tr>
                        <tr>
                            <td style="width: 98px; background-color: #ccccff;">
                                分类号：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="work_ty" type="text" value="" class="inputbox"  runat="server" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                学科：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="work_sub" type="text" value="" class="inputbox"  runat="server" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                发表年份：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="work_time" type="text" value="" class="inputbox"  runat="server" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                卷期页码：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="work_page" type="text" value="" class="inputbox" runat="server" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                类型：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="work_type" type="text" value="" class="inputbox" runat="server" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                作者：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="work_auth" type="text" value="" class="inputbox" disabled="disabled"  runat="server" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                其他作者：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="work_oauth" type="text" value="" class="inputbox"  runat="server"  /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                作者机构：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="work_organ" type="text" value="" class="inputbox"  runat="server" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                基金：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="work_fund" type="text" value="" class="inputbox"  runat="server" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                备注：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="work_remark" type="text" value="" class="inputbox"  runat="server" /></td>
                        </tr>
                    </table>
          </div>
