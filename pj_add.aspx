<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pj_add.aspx.cs" Inherits="pj_add" %>
          ...
          <table width="60%" style=" margin-top:3%; margin-left:20%">
                        ...
                        <tr>
                            ...
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="pj_name" type="text" value="" class="inputbox"  runat="server"  /></td>
                        </tr>
                        <tr>
                            <td style="width: 98px; background-color: #ccccff;">
                                教师姓名：</td>
                        ...
                        <tr>
                            <td style="width: 98px; background-color: #ccccff;">
                                项目来源：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="pj_source" type="text" value="" class="inputbox"  runat="server" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                立项时间：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="pj_pretime" type="text" value="" class="inputbox"  runat="server" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                研制时间段：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="pj_time" type="text" value="" class="inputbox"  runat="server" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                项目金额：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="pj_money" type="text" value="" class="inputbox" runat="server" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                来源部门：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="pj_sour_depart" type="text" value="" class="inputbox" runat="server" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                合作部门：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="pj_co_depart" type="text" value="" class="inputbox"  runat="server" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                项目成员：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="pj_memb" type="text" value="" class="inputbox"  runat="server"  /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 98px; background-color: #ccccff;">
                                备注：</td>
                            <td style="width: 246px; background-color: #ccccff;">
                                <input id="pj_remark" type="text" value="" class="inputbox"  runat="server" /></td>
                        </tr>
                    </table>
          </div>
